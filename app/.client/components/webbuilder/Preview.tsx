  ...
  const HASH_LINK_INTERCEPTOR_SCRIPT = `
    document.addEventListener('click', function(e) {
      ...
      if(target && target.tagName === 'A') {
        ...
        // 对于其他链接（包含路径的链接如page.html#section），让其正常工作
        // 不做任何处理
      }
    }, true);
  `;
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex items-center relative">
            <IconButton
              ...
              title={`在 ${selectedWindowSize.name} 窗口中打开预览`}
            />
            <IconButton
                ...
                <div className="absolute right-0 top-full mt-2 z-50 min-w-[240px] max-h-[400px] overflow-y-auto bg-white dark:bg-black rounded-xl shadow-2xl border border-[#E5E7EB] dark:border-[rgba(255,255,255,0.1)] overflow-hidden">
                  <div className="p-3 border-b border-[#E5E7EB] dark:border-[rgba(255,255,255,0.1)]">
                    <div className="flex items-center justify-between mb-2">
                      <span className="text-sm font-medium text-[#111827] dark:text-gray-300">设备选项</span>
                    </div>
                    <div className="flex flex-col gap-2">
                      <div className="flex items-center justify-between">
                        <span className="text-xs text-[#6B7280] dark:text-gray-400">显示设备框架</span>
                        <button
                      ...
                      <div className="flex items-center justify-between">
                        <span className="text-xs text-[#6B7280] dark:text-gray-400">横屏模式</span>
                        <button
                          className={`w-10 h-5 rounded-full transition-colors duration-200 ${

...
CREATE TABLE "PageV2" (
    ...
    CONSTRAINT "PageV2_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "PageV2" ADD CONSTRAINT "PageV2_messageId_fkey" FOREIGN KEY ("messageId") REFERENCES "Message"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "PageAsset" ADD CONSTRAINT "PageAsset_pageId_fkey" FOREIGN KEY ("pageId") REFERENCES "PageV2"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Section" ADD CONSTRAINT "Section_pageV2Id_fkey" FOREIGN KEY ("pageV2Id") REFERENCES "PageV2"("id") ON DELETE CASCADE ON UPDATE CASCADE;
